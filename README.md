...
> Looking for another stack? See the [Next.js](https://github.com/contioreach/nextjs-starter-contioreach) and [Nuxt](https://github.com/contioreach/nuxtjs-starter-contioreach) examples.
